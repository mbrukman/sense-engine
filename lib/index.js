...
function Engine(options) {
  ...
  if (options.startupScript !== undefined && options.startupScript !== 'undefined') {
    this._startupScript = fs.readFileSync(options.startupScript).toString();
  }
  else if (options.startupCode !== undefined && options.startupCode !== 'undefined') {
